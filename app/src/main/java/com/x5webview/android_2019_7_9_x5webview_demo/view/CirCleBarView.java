...
public class CirCleBarView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mRadius = typeArray.getDimension(R.styleable.TasksCompletedView_db_radius, 45);//大圆半径
        mStrokeWidth = typeArray.getDimension(R.styleable.TasksCompletedView_strokeWidth, 10);//大圆小圆之差
        mCircleColor = typeArray.getColor(R.styleable.TasksCompletedView_circleColor, 0xFFFFFFFF);
        mRingColor = typeArray.getColor(R.styleable.TasksCompletedView_ringColor, 0xFFFFFFFF);
        mRingBgColor = typeArray.getColor(R.styleable.TasksCompletedView_ringBgColor, 0xFFFFFFFF);
        mRingTextColor = typeArray.getColor(R.styleable.TasksCompletedView_ringTextColor, 0x000000);
    ...
    private void initVariable() {
        ...
        mCirclePaint.setStyle(Paint.Style.STROKE);//画笔类型
        ...
        mTextPaint.setColor(mRingTextColor);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mProgress > 0) {
            ...
            //字体
            String txt = ((int) (mProgress * 100 / mTotalProgress)) + "%";
